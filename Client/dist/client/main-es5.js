(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function T45(module, __webpack_exports__, __webpack_require__) {
      ...
      MembersService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
    ...
    function IiJT(module, __webpack_exports__, __webpack_require__) {
      ...
      SharedModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({
        ...
        }), ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_4__["TabsModule"].forRoot()], ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_1__["BsDropdownModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrModule"], ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_4__["TabsModule"]]
      });
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](SharedModule, {
          ...
          exports: [ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_1__["BsDropdownModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_3__["ToastrModule"], ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_4__["TabsModule"]]
        });
      })();
      /***/
                ...
                switch (error.status) {
                  case 400:
                    if (error.error.errors) {
                      ...
                      _this4.toastr.error(error.statusText, error.status);
                    }

                    break;

                  case 401:
                    _this4.toastr.error(error.statusText, error.Status); //  this.toastr.error(error.Status === 'OK' ? "Unauthorised" : error.statusText, error.status);


                    break;

                  case 404:
                    _this4.rounter.navigateByUrl('/not-found');
                  ...
                  case 500:
                    ...
                    _this4.rounter.navigateByUrl('/server-error', navigationExtras);

                    break;

                  default:
                    _this4.toastr.error('Something unexpected went wrong');
    ...
    function PL33(module, __webpack_exports__, __webpack_require__) {
      ...
      MemberDetailComponent.ɵfac = function MemberDetailComponent_Factory(t) {
        return new (t || MemberDetailComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_Services_members_service__WEBPACK_IMPORTED_MODULE_1__["MembersService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]));
      };
      ...
      MemberDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 1,
        vars: 1,
        consts: [["class", "row", 4, "ngIf"], [1, "row"], [1, "col-4"], [1, "card"], [1, "card-img-top", "img-thumbnail", 3, "src", "alt"], [1, "card-body"], [1, "card-footer"], [1, "btn-group", "d-flex"], [1, "btn", "btn-primary"], [1, "btn", "btn-success"], [1, "col-8"], [1, "member-tabset"], [3, "heading"], ["heading", "Interests"], ["heading", "Photos"], ["heading", "Messages"]],
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"], ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_4__["TabsetComponent"], ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_4__["TabDirective"]],
        ...
        _createClass(AuthGuard, [{
          ...
          value: function canActivate() {
            ...
            return this.accountService.currentUser$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (user) {
              ...
              _this6.toastr.error("You shall not pass!");
            }));
          }
        }]);
      ...
      var MemberListComponent = /*#__PURE__*/function () {
        ...
        _createClass(MemberListComponent, [{
          ...
          value: function loadMembers() {
            ...
            this.memberServices.getMembers().subscribe(function (members) {
        ...
        _createClass(NavComponent, [{
          ...
          value: function login() {
            ...
            this.accountService.login(this.model).subscribe(function (resposne) {
              _this8.router.navigateByUrl('/members');
            }, function (error) {
              _this8.toastr.error(error.error);
            });
          }
        }, {
          key: "logout",
        ...
        _createClass(MemberEditComponent, [{
          ...
          value: function updateMember() {
            ...
            this.memberService.updateMember(this.member).subscribe(function () {
              _this12.toastr.success('Profile updated successfully');

              _this12.editForm.reset(_this12.member);
            });
          }
        }]);
